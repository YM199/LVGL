...
WARNINGS = -Wall -Wshadow -Wundef -Wmaybe-uninitialized -Wmissing-prototypes \
		   -Wno-discarded-qualifiers -Wall -Wextra -Wno-unused-function -Wundef \
		   ...
		   -Wno-switch-enum -Wreturn-type -Wmultichar -Wformat-security -Wno-ignored-qualifiers \
		   ...
		   -Wstack-usage=1024 -Wno-unused-value -Wno-unused-parameter -Wno-missing-field-initializers \
		   -Wuninitialized -Wmaybe-uninitialized -Wall -Wextra -Wno-unused-parameter -Wno-missing-field-initializers \
		   -Wtype-limits -Wsizeof-pointer-memaccess -Wno-format-nonliteral -Wpointer-arith -Wno-cast-qual -Wmissing-prototypes \
